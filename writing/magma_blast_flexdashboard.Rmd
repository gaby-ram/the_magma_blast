...
volcano_timeline = ggplot() +
  ...
  geom_segment(aes(y = 0, yend = 0, x = 1959, xend = 2021), 
               size = 1,
               colour = "black",
               arrow = arrow()) +
  ...
  theme(plot.background = element_rect(fill = "#303030"),
        ...
        plot.subtitle = element_text(colour = "#B3B3B3", hjust = 0.5, face = "bold", size = 12),
        ...
        legend.text = element_text(colour = "#B3B3B3", size = 14),
