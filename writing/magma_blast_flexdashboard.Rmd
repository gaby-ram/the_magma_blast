...
usa_volc <- volcano %>% 
  ...
  mutate(subregion = factor(subregion, levels = c("USA (Washington)", "Aleutian Islands", "Alaska Peninsula", "Alaska (southwestern)", "USA (Oregon)", "USA (Idaho)", "USA (Utah)", "USA (New Mexico)", "USA (California)",  "Alaska (eastern)", "Hawaiian Islands", "Alaska (western)", "USA (Arizona)", "USA (Nevada)", "USA (Wyoming)" ), 
                      labels = c("Washington", "Aleutian Islands", "Alaska Peninsula", "Alaska", "Oregon", "Idaho", "Utah", "New Mexico", "California",  "Alaska", "Hawaii", "Alaska", "Arizona", "California", "Wyoming" )))%>%
  select(volcano_number, volcano_name, primary_volcano_type:subregion, elevation:longitude)%>%
  arrange(.data = usa_volc, subregion)
